    ...
    return (
        <div className="py-14 px-6 md:px-20 lg:px-32 grid">
            <div className="border mb-4 w-fit sm:mx-auto py-1.5 px-3 rounded-full bg-background">
                <a className="hover:underline" href="">
                    <p className="text-xs flex items-center justify-center gap-1">
                        ✨ Contribute to thisDHADHHAJHDJHAYUFGAOOOOOOOOOOOOOOOSFYU<ArrowRight className="h-4 w-4" />
                    </p>
                </a>
            </div>
            <div className="grid sm:place-content-center sm:text-center gap-2">
                <h2 className="text-3xl max-w-md sm:max-w-3xl md:max-w-4xl sm:text-4xl font-medium md:text-5xl text-gray-900 dark:text-gray-50">ADHJDHHJAHHAHDJDJHDHAHHAHDCASJH <span className="animate-text-gradient inline-flex bg-gradient-to-r from-neutral-900 via-slate-500 to-neutral-500 bg-[200%_auto] bg-clip-text leading-tight text-transparent dark:from-neutral-100 dark:via-slate-400 dark:to-neutral-400">one single accessable link.</span></h2>
            ...
            <div className="sm:flex items-center sm:justify-center grid grid-cols-2 gap-2.5 mt-7">
                ...
                <Button variant="outline" asChild><Link href="/r2hu1" className="flex items-center gap-1">sdsd <ArrowRight className="h-4 w-4 -rotate-45" /></Link></Button>
            </div>
